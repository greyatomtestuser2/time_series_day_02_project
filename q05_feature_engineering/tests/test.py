...
from ..build import q05_feature_engineering student
...
class Testing(unittest.TestCase):
    def setUp(self):
        with open('q05_feature_engineering/tests/user_sol.pkl', 'wb') as f:
            dill.dump(student, f)

        with open('q05_feature_engineering/tests/test_sol.pkl', 'wb') as f:
            dill.dump(original, f)
        with open('q05_feature_engineering/tests/user_sol.pkl', 'rb') as f:
            self.student_func = dill.load(f)
        with open('q05_feature_engineering/tests/test_sol.pkl', 'rb') as f:

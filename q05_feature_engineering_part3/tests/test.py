...
class Testing(unittest.TestCase):
    def setUp(self):
        with open('q05_feature_engineering_part3/tests/user_sol.pkl', 'wb') as f:
            dill.dump(student, f)

        with open('q05_feature_engineering_part3/tests/test_sol.pkl', 'wb') as f:
            dill.dump(original, f)
        with open('q05_feature_engineering_part3/tests/user_sol.pkl', 'rb') as f:
            self.student_func = dill.load(f)
        with open('q05_feature_engineering_part3/tests/test_sol.pkl', 'rb') as f:
